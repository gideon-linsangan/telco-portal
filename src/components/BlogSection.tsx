  ...
  return (
    <section className="w-full bg-white py-12 md:py-20">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        {/* Header row */}
        <div className="flex items-start md:items-end justify-between gap-4 mb-8 md:mb-10">
          <div>
            <p className="text-xs font-medium uppercase tracking-widest text-brand-signature mb-2.5">Blog</p>
            <h2 className="text-2xl md:text-3xl font-bold text-neutral-ink tracking-tight">From the TelcoNow blog</h2>
          </div>
          <NextLink href="#" className="text-brand-signature hover:text-brand-mid text-[14px] font-semibold transition-colors flex-shrink-0 mt-1 md:mb-1.5">
            View all →
          </NextLink>
        </div>
