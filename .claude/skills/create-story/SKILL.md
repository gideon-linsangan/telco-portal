...
- **Never invent content:** do not guess labels, link names, nav items, copy, or field names from training data. If the design file has not been read, flag every content detail as uncertain. Only write specific content you can verify from the design file or stub JSON.
